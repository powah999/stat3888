...
sheets <- excel_sheets("Data/AHSinpBasicCURFdataItemList-2.xls")
...
for (sheet in sheets){
  ...
  df <- read_excel("Data/AHSinpBasicCURFdataItemList-2.xls",
                   sheet = sheet, skip = 6)
...
head(combined_dictionary)

# install.packages("writexl")

library(writexl)

write_xlsx(combined_dictionary, "combined_dictionary.xlsx")
write.csv(combined_dictionary, "combined_dictionary.csv", row.names = FALSE)
